  ...
  navItems: NavItem[] = [
    ...
    },
    {
      ...
      subItems: [
        ...
        { name: "Delivery Challans", path: "/delivery-challans", pro: false },
        { name: "Invoices", path: "/invoices", pro: false },
        { name: "Payments Received", path: "/payments-received", pro: false },
        { name: "Credit Notes", path: "/credit-notes", pro: false }
      ],
    },
    {
      name: "Purchases",
      ...
      subItems: [
        ...
        { name: "Payments Made", path: "/payments-made", pro: false },
        { name: "Vendor Credits", path: "/vendor-credits", pro: false },
      ],
    },
    {
      name: "Tables",
